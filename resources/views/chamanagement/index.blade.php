        ...
        <thead>
           ...
           <tr>
                ...
                @IF(!empty(Auth::user()) && Auth::user()->role_id == 1)
                    <th class="text-center"><a href="{{url('chamanagement/add')}}" class="btn btn-primary"><span class="glyphicon glyphicon-plus">ADD Cha</a></th>
                @ELSE
            ...
            ?>
               <tr>
                    ...
                    @IF(!empty(Auth::user()) && Auth::user()->role_id == 1)
                      ...
                      <a href="{{url('chamanagement/update/'.$data['id'])}}" class="btn btn-success"><i class="fa fa-pencil"> Edit</i></a>
                     
                         <a href="{{url('chamanagement/delete/'.$data['id'])}}" class="btn btn-danger" onclick="myFunction()"><span class="glyphicon glyphicon-trash">Delete</a>
