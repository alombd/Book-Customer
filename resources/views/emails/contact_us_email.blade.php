                                          ...
                                          <tr>
                                             <td width="30" height="30" align="right">
                                                <div class="imgpop">
                                                   ...
                                                   <img src="{{ URL::asset('public/img/Email_img/facebook.png') }} " alt="" border="0" width="30" height="30" style="display:block; border:none; outline:none; text-decoration:none;">
                                                   </a>
                                                </div>
                                             </td>
                                             ...
                                             <td width="30" height="30" align="center">
                                                <div class="imgpop">
                                                   <a target="_blank" href="#">
                                                   <img src="{{ URL::asset('public/img/Email_img/twitter.png') }}" alt="" border="0" width="30" height="30" style="display:block; border:none; outline:none; text-decoration:none;">
                                                   </a>
                                                </div>
                                             </td>
                                             <td align="left" width="20" style="font-size:1px; line-height:1px;">&nbsp;</td>
                                             <td width="30" height="30" align="center">
                                                <div class="imgpop">
                                                   <a target="_blank" href="#">
                                                   <img src="{{ URL::asset('public/img/Email_img/linkedin.png') }}" alt="" border="0" width="30" height="30" style="display:block; border:none; outline:none; text-decoration:none;">
                                                   </a>
                                                </div>
                                             </td>
                                          </tr>
                                       ...
                                       <tbody>
                                          <tr>
                                             <td width="169" height="45" align="center">
                                                <div class="imgpop">
                                                   <a target="_blank" href="#">
                                                   <img src="{{ URL::asset('public/img/Email_img/logo.png') }}" alt="" border="0" width="169" height="45" style="display:block; border:none; outline:none; text-decoration:none;">
                                                   </a>
                                                </div>
                                             </td>
                                          </tr>
                           ...
                           <tbody>
                              <tr>
                                 ...
                                 <td align="center" st-image="banner-image">
                                    <div class="imgpop">
                                       <a target="_blank" href="#"><img width="600" border="0" height="300" alt="" border="0" style="display:block; border:none; outline:none; text-decoration:none;" src="{{ URL::asset('public/img/Email_img/banner.png') }}" class="banner"></a>
                                    </div>
                                 </td>
                              </tr>
                           </tbody>
                                       ...
                                       <tbody>
                                          ...
                                          <tr>
                                             <td width="100%" align="center" class="devicewidth">
                                                <img src="{{ URL::asset('public/img/Email_img/icon1.png') }}" alt="" border="0" width="50" height="50" style="display:block; border:none; outline:none; text-decoration:none;">
                                             </td>
                                          </tr>
                                          <!-- end of image2 -->
                                          <tr>
                                                   ...
                                                   <tbody>
                                                      ...
                                                      <tr>
                                                         <td width="290" height="160" align="center" class="devicewidth">
                                                            <img src="{{ URL::asset('public/img/Email_img/ipad.png') }}" alt="" border="0" width="290" height="160" style="display:block; border:none; outline:none; text-decoration:none;" class="colimg2">
                                                         </td>
                                                      </tr>
                                                      <!-- Content -->
                                                      <tr>
